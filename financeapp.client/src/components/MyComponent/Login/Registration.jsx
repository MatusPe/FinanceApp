...
import {LoginAPI, RegisterAPI} from "@/components/MyComponent/Services/AuthServices.jsx";
...
export const Registration=({setshowComponent})=>{
    ...
    const handleRegistration = async (form) => {
        ...
        try {
            console.log('jghdh')
            console.log(form)
            RegisterAPI(form.userName, form.email, form.password).then(res=>{
                if (res) {
